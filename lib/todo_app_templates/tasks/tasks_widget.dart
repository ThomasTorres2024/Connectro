...
import '/todo_app_templates/add_task/add_task_widget.dart';
import '/todo_app_templates/task/task_widget.dart';
import '/index.dart';
        ...
        floatingActionButton: FloatingActionButton(
          ...
          child: Container(
            ...
            child: InkWell(
              ...
              onTap: () async {
                logFirebaseEvent('TASKS_PAGE_Icon_138kg65l_ON_TAP');
                  ...
                  child: StreamBuilder<List<TasksRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'TASKS_PAGE_ListView_5ztvyz1c_ON_TAP');
                        ...
                        child: ListView.separated(
                          ...
                          itemBuilder: (context, listViewIndex) {
                            ...
                            return InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'TASKS_PAGE_Container_jbtaskg7_ON_TAP');
                              ...
                              child: TaskWidget(
                                ...
                                checkAction: () async {
                                  logFirebaseEvent(
                                      'TASKS_PAGE_Container_jbtaskg7_CALLBACK');
