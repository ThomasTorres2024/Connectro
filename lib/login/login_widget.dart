                                    ...
                                    children: [
                                      Flexible(
                                        child: Container(
                                          ...
                                          child: TextFormField(
                                            key: ValueKey('Signup-Email_6ola'),
                                            controller: _model
                                      ...
                                      Container(
                                        width: double.infinity,
                                        child: TextFormField(
                                          key: ValueKey('Signup-Password_r2hf'),
                                          controller: _model
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        width: double.infinity,
                                        child: TextFormField(
                                          key: ValueKey('Login-Password_t0pw'),
                                          controller: _model
                                          ...
                                          onFieldSubmitted: (_) async {
                                            logFirebaseEvent(
                                                'LOGIN_Login-Password_ON_TEXTFIELD_SUBMIT');
                                            logFirebaseEvent(
                                                'Login-Password_auth');
                                            GoRouter.of(context)
                                                .prepareAuthEvent();
                        ...
                        if (_model.tabBarCurrentIndex == 0)
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                30.0, 0.0, 0.0, 0.0),
                            child: FFButtonWidget(
                              key: ValueKey('Signup-Button_gp6i'),
                              onPressed: () async {
                                logFirebaseEvent(
                                    'LOGIN_PAGE_Signup-Button_ON_TAP');
                                logFirebaseEvent('Signup-Button_validate_form');
